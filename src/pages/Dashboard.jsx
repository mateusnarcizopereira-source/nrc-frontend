    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        {usuario?.perfil === 'corretor' && (
          ...
          >
            <span
              className={`w-2 h-2 rounded-full ${presenca ? 'animate-pulse' : ''}`}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {CARDS.map((c) => (
          <div key={c.key} className="card">
            ...
            <p className="metric-number mt-1" style={{ color: c.cor }}>
              {contagem[c.key] ?? 0}
            </p>
          </div>
        ))}
                    ...
                    <span
                      ...
                      style={
                        isProximo
                          ...
                          : { background: '#1E1E24', color: '#6A6A70' }
                      }
                    >
      ...
      <div className="card p-0 overflow-hidden">
        ...
        >
          ...
          <Link to="/leads" className="text-sm font-semibold" style={{ color: '#C0392B' }}>
